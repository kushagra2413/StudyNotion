...
if (!instance) {
  console.warn("WARNING: Razorpay instance is not available. Payment functionality will be limited.")
}
...
exports.capturePayment = async (req, res) => {
  ...
  if (!courses || courses.length === 0) {
    console.log("ERROR: No courses provided")
  ...
  for (const course_id of courses) {
    ...
    try {
      ...
      if (!course) {
        console.log("ERROR: Course not found for ID:", course_id)
        return res
          .status(200)
      ...
      console.log("Checking enrollment for user:", uid.toString())
      
      if (enrolledStudents.some(student => student.toString() === uid.toString())) {
      ...
      console.log("Added course price. Total amount so far:", total_amount)
    } catch (error) {
